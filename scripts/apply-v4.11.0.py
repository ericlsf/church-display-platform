...
def patch_app():
    ...
    import_line = "from routes.fleet_map import fleet_map_bp"
    ...
    register_line = "    app.register_blueprint(fleet_map_bp)"
...
def patch_navigation():
    ...
    if 'href="/fleet-map"' in text:
        return

    link = '<a href="/fleet-map">Fleet Map</a>'
...
def main():
    ...
    patch_navigation()
    patch_css()
    print("v4.11.0 Fleet Map applied.")
