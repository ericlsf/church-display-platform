...
def patch_app():
    ...
    import_line = "from routes.audit import audit_bp"
    ...
    register_line = "    app.register_blueprint(audit_bp)"
...
def patch_navigation():
    ...
    if 'href="/audit"' in text:
        return

    link = '<a href="/audit">Audit History</a>'
    for marker in [
        'href="/history"',
...
def main():
    ...
    patch_navigation()
    patch_css()
    print("v4.8.0 Audit History applied.")
